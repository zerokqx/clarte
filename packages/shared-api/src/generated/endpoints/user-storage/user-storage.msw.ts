...
export const getUserStorageControllerGetPresignedUrlMockHandler = (
  overrideResponse?:
    | UserS3StorageDTO
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<UserS3StorageDTO> | UserS3StorageDTO),
...
export const getUserStorageMock = () => [getUserStorageControllerGetPresignedUrlMockHandler()];
