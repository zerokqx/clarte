...
execSync(`mv ${root}/application/decorators/hocuspocus*.ts ${root}/app/hocuspocus/application/decorators/`);
...
fs.writeFileSync(`${root}/app/auth/application/ports/di-tokens.ts`, 
