...
type FieldsArgsFn<TPrefixVale extends string | undefined> = (TPrefixVale extends string
  ? {
...
interface PrefixOptions<TValue extends string | undefined = undefined> extends PrefixForEnvOption {
  value?: TValue;
}

interface CompactConfigOptions<T extends object, TValue extends string | undefined = undefined> {
...
export class CompactConfigModule {
  public static register<T extends object, TValue extends string | undefined = undefined>({
    registerAsName,
    prefixOptions: { value, ...options } = prefixOptionsDefault as PrefixOptions<TValue>,
    fields,
  }: CompactConfigOptions<T, TValue>): DynamicModule {
    const prefix = value !== undefined ? prefixForEnv(value, options) : undefined;
