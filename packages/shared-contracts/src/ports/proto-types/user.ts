...
export interface UserEditServiceClient {
  userChangeAvatar(request: UserEditChangeAvatarRequest, metadata?: Metadata): Observable<Empty>;

  userChangeLogin(request: UserEditChangeLoginRequest, metadata?: Metadata): Observable<Empty>;
}

export interface UserEditServiceController {
  userChangeAvatar(request: UserEditChangeAvatarRequest, metadata?: Metadata): void | Promise<void>;

  userChangeLogin(request: UserEditChangeLoginRequest, metadata?: Metadata): void | Promise<void>;
}
...
export interface UserStorageServiceClient {
  uploadPresignedUrl(request: Empty, metadata?: Metadata): Observable<UploadPresignedUrlResponse>;
}
...
export interface UserCreateServiceClient {
  userCreate(request: UserCreateRequest, metadata?: Metadata): Observable<Empty>;
}

export interface UserCreateServiceController {
  userCreate(request: UserCreateRequest, metadata?: Metadata): void | Promise<void>;
}
...
export interface UserFindServiceClient {
  findById(request: UserFindByIdRequest, metadata?: Metadata): Observable<UserFindByIdResponse>;
