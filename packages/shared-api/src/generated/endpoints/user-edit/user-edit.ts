...
export const userEditControllerChangeLogin = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      return customInstance<void>(
      {url: `/api/users/change-login`, method: 'PATCH',
      headers: {'Content-Type': 'application/json', },
      data: userChangeLoginDTO, signal
    },
      options);
    }
...
export const getUserEditControllerChangeLoginMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof userEditControllerChangeLogin>>, TError,{data: BodyType<UserChangeLoginDTO>}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof userEditControllerChangeLogin>>, TError,{data: BodyType<UserChangeLoginDTO>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof userEditControllerChangeLogin>>, {data: BodyType<UserChangeLoginDTO>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UserEditControllerChangeLoginMutationResult = NonNullable<Awaited<ReturnType<typeof userEditControllerChangeLogin>>>
 ...
 * @summary Изменить логин пользователя
 */
export const useUserEditControllerChangeLogin = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof userEditControllerChangeLogin>>, TError,{data: BodyType<UserChangeLoginDTO>}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
